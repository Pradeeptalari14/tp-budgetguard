...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/budgetguard/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-budgetguard.git
cd tp-budgetguard
```
...
```bash
kubectl port-forward deployment/tp-budgetguard 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── budget_decorator.py     # Main configuration file
```
...
---
*Generated by [BudgetGuard Studio](https://pradeeptalari14.github.io/portfolio/tools/budgetguard/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
